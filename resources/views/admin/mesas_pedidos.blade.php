...
@push('scripts')
    <script>
        ...
        window.Textos.mesaControle = {
            ...
            entregue: @json(texto('admin_mesas_controle', 'estado.entregue', 'Entregue')),
            entregue_mesa: @json(texto('admin_mesas_controle', 'estado.entregue_mesa', 'Entregue na mesa')),
            modal_confirmar_entrega: @json(texto('admin_mesas_controle', 'modal.confirmar_entrega', 'Confirmar marcação de entregue na mesa?')),
